...
<%@ include file="/nav-f1"%>
	...
	<nav aria-label="breadcrumb">
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item"><a href="#">緯明助教</a></li>
			<li class="breadcrumb-item"><a href="#">瑋齊助教</a></li>
			<li class="breadcrumb-item"><a href="#">組長消失</a></li>
		</ol>
	</nav>
		...
		<div class="row">
			...
			<div class="col-9">
				<form METHOD="post" ACTION="<%=request.getContextPath()%>/front-end/WishOrd/wishOrd.do">
						...
						<div class="row">
							<table>
								...
								<c:forEach var="wishSellItemVO" items="${wishSellList}">
									<tr>
										<td><img src="<%=request.getContextPath()%>/getDatabaseServlet.do?wishItemNo=${wishSellItemVO.wishItemNo}"
									...
									<% 
							sellTotal = sellTotal + wishSellList.get(i).getItemPrice()*wishSellList.get(i).getAmount();
							i++;
							%>
								</c:forEach>
							</table>
					...
					<div class="container" align="left">
						<div align="left" style="width: 60%">
							...
							<table>
								...
								<tr>
									<td>託買會員:<font color=red><b>*</b></font></td>
									<td><input type="text" class="form-control" id="wishMemNo1" name="wishMemNo1"
										value="<%=(wishSellList.get(i).getMemNo() == null) ? "MEM0001" : wishSellList.get(i).getMemNo()%>"
										required readonly/></td>
								</tr>
								<tr>
					...
					<div align="center">
					<input type="hidden" name="action" value="buycheckout">
