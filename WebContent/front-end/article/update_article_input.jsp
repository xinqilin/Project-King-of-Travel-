...
<title>update_article_input.jsp</title>
...
<!-- 	<input type="submit" value="送出修改"></FORM> -->
		...
		<div class=""
			style="width: 600px; height: 600px; margin: 0 auto; border:2px outset #DCDCDC; border-radius:10px; padding: 10px;">
			<FORM METHOD="post"
				...
				<input type="hidden" name="articleno"
					...
					type="hidden" name="tripno" value="<%=articleVO.getTripno()%>">
				...
				<div class="form-date">
					<input type="text" readOnly="true" name="dayofstart" id="f_date1"
						value="<%=articleVO.getDayofstart()%>"><span> ～ </span><input
						type="text" readOnly="true" name="dayofend" id="f_date2"
						value="<%=articleVO.getDayofend()%>"><span>共<input
						type="text" readOnly="true" name="daysofstaying" size="4"
				...
				<input type="hidden" name="articlestatus"
					...
					<input type="hidden" name="dayoflastedit" id="f_date3"
				...
				<span>想放的封面照：</span>
				<td><input type="file" name="trippic" size="45" id="imgInp"
						...
						<c:if test="${articleVO.articlepic==null}">
							...
							<img
								...
								id="blah"
								style="border-radius: 20px; border:1px; width: 200px; height: 200px;">
						</c:if></td>
				
				<input type="hidden" name="dayofcreate"
