...
<%
String tripno = (String) request.getParameter("tripVO"); 
System.out.println(tripno);

	TripDetailsService tripDetailsSvc = new TripDetailsService();
	List<TripDetailsVO> list = tripDetailsSvc.getfindByTripno(tripno);
	TripService trip666=new TripService();
	TripVO tripVO=trip666.getlastOne();
