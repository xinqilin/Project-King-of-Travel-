...
<%
	...
	for(int i =0;i<wishList.size();i++){
		int j=0;
		if((wishList.get(i)).getBuyOrSell()==1){
			wishSellList.add(j, wishList.get(i));
		...
		<div class="row">
			<div class="col-3">
				<div class="nav flex-column nav-pills" id="v-pills-tab"
					...
					<a class="nav-link active" href="<%=request.getContextPath()%>/front-end/WishItem/wishItem_sellList.jsp">代購商品專區</a>
			...
			<%@ include file="wishSellListPage1.file" %>			
				<div class="row">
				<c:forEach var="wishItemVO" items="${wishSellList}" begin="<%=pageIndexSell%>" end="<%=pageIndexSell+rowsPerPageSell-1%>">
