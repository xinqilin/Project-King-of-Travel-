...
<%
  FuncListVO funcListVO = (FuncListVO) request.getAttribute("funcListVO"); //FuncListServlet.java (Concroller) 存入req的funcListVO物件 (包括幫忙取出的funcListVO, 也包括輸入資料錯誤時的funcListVO物件)
%>

<html>
<head>
<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
<title>管理員功能修改 - update_func_input.jsp</title>
...
<table id="table-1">
	<tr><td>
		 <h3>管理員功能修改 - update_func_input.jsp</h3>
