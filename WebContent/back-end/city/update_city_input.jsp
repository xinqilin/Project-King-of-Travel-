...
<%
  CityVO cityVO = (CityVO) request.getAttribute("cityVO"); //CityServlet.java (Concroller) 存入req的cityVO物件 (包括幫忙取出的cityVO, 也包括輸入資料錯誤時的cityVO物件)
%>

<html>
<head>
<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
<title>城市資料修改 - update_city_input.jsp</title>
...
<table id="table-1">
	<tr><td>
		 <h3>城市資料修改 - update_city_input.jsp</h3>
...
<table>
	<tr>
		<td>城市編號:<font color=red><b>*</b></font></td>
