...
<table>
	<tr>
		...
		<td><input type="TEXT" name="memName" size="45" 
			 value="<%= (memVO==null)? "吳永志" : memVO.getMemName()%>" /></td>
	</tr>
	<tr>
		<td>Email:</td>
		<td><input type="TEXT" name="e_mail" size="45"
			 value="<%= (memVO==null)? "seafood@gmail.com" : memVO.getE_mail()%>" /></td>
	</tr>
	<tr>
		<td>密碼:</td>
		<td><input type="TEXT" name="memPassWd" size="45"
			 value="<%= (memVO==null)? "12345678" : memVO.getMemPassWd()%>" /></td>
	</tr>
	<tr>
		<td>頭像:</td>
		<td><input type="file" name="memPhoto" size="45" />
<!--                <input type="submit" value="上傳"></td> -->
	...
	<tr>
		...
		<td><input type="TEXT" name="nickName" size="45"
			 value="<%= (memVO==null)? "吳神" : memVO.getNickName()%>" /></td>
	</tr>
	<tr>
		<td>身分證字號:</td>
		<td><input type="TEXT" name="idNo" size="45"
			 value="<%= (memVO==null)? "A123456789" : memVO.getIdNo()%>" /></td>
	</tr>	
	<tr>
		<td>生日:</td>
	...
	<tr>
		...
		<td><input type="TEXT" name="address" size="45"
			 value="<%= (memVO==null)? "桃園市中壢區中大路300號" : memVO.getAddress()%>" /></td>
	</tr>
	<tr>
		<td>電話:</td>
		<td><input type="TEXT" name="phone" size="45"
			 value="<%= (memVO==null)? "0912-123456" : memVO.getPhone()%>" /></td>
	</tr>

<%-- 	<jsp:useBean id="deptSvc" scope="page" class="com.mem.model.MemService" /> --%>
<!-- 	<tr> -->
