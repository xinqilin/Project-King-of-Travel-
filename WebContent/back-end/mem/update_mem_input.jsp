...
<table>
	...
	<tr>
		<td>Email:</td>
		<td><input type="TEXT" name="e_mail" size="45"	value="<%=memVO.getE_mail()%>" /></td>
	</tr>
	<tr>
		<td>密碼:</td>
		<td><input type="TEXT" name="memPassWd" size="45"	value="<%=memVO.getMemPassWd()%>" /></td>
	</tr>
	<tr>
		<td>頭像:</td>
...
<!--                <input type="submit" value="上傳"></td> -->
	...
	<tr>
		<td>暱稱:</td>
		<td><input type="TEXT" name="nickName" size="45"	value="<%=memVO.getNickName()%>" /></td>
	</tr>
	<tr>
		<td>身分證字號:</td>
		<td><input type="TEXT" name="idNo" size="45"	value="<%=memVO.getIdNo()%>" /></td>
	</tr>
	<tr>
		<td>生日:</td>
...
<!-- 	<tr> -->
<!-- 		<td>部門:<font color=red>  </b></font></td> -->
...
<script>
        ...
        $('#f_date1').datetimepicker({
           theme: '',              //theme: 'dark',
 		   ...
 		   value: '<%=memVO.getBirDay()%>', // value:   new Date(),
